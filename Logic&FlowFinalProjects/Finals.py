...
def transform_dataset(data):
    ...
    for student in data:
        ...
        if all(grade > 70 for grade in student['grades']):  # Check if all grades are above 70
            qualified_students[student['student_id']] = avg
    
    # Step 2: Create a summary of subjects taken by qualified students
    subject_counts = {}
    for student in data:
        if student['student_id'] in qualified_students:  # Only consider qualified students
    ...
    final_dict['qualified_students'] = qualified_students
    final_dict['subject_summary'] = subject_counts
    return final_dict
